function MC_Load_Poses_On_Selected_Frames()
{
	...
	this.ui.listBox.reloadButton.icon = new QIcon( imagePath + "/MC_Load_Poses_On_Selected_Frames_refresh.png" );
	this.ui.listBox.reloadButton.setIconSize(new QSize(28,28));	
	this.ui.loadButton.icon = new QIcon( imagePath + "/MC_Load_Poses_On_Selected_Frames_load.png" );
	this.ui.loadButton.setIconSize(new QSize(50,22));	
	this.ui.showButton.icon = new QIcon( imagePath + "/MC_Load_Poses_On_Selected_Frames_Show.png" );
